...
const Footer = () => {
  ...
  const { isLoading } = useSelector((state) => state.bookingMovie);
  const homeLoader = useSelector((state) => state.manageMovie.isLoading);
            ...
            <div className="md:flex md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-8 sm:gap-8 sm:grid-cols-2">
                <div>
                  ...
                  <ul className="text-gray-600 font-medium grid grid-cols-3 gap-4">
                    {releaseList?.map((item, id) => {
                      return (
                        <li className="mb-4" key={id}>
                          <a href="/">
                            <img
                              className="w-[60px] hover:scale-105"
                              src={item.logo}
                              alt={item.logo}
                            />
                          </a>
